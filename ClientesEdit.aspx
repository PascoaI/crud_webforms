<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClientesEdit.aspx.cs" Inherits="crud_webforms.ClienteEdit" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container mt-4">
            ...
            <asp:HiddenField ID="CLI_ID" runat="server" />
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="CLI_DATANASCIMENTO" runat="server" CssClass="form-control col-md-6" TextMode="Date"></asp:TextBox>
            ...
            <div class="form-group form-check">
                <asp:CheckBox ID="CLI_ATIVO" runat="server" CssClass="form-check-input" />
            ...
            <asp:LinkButton ID="btnCancelar" CausesValidation="false" runat="server" CssClass="btn btn-secondary" PostBackUrl="~/ClientesList.aspx">
